# Your 𝐅𝐑𝐄𝐍𝐂𝐇 Mistral DevOps Teacher 🇫🇷🐈
    ...
    Config prête à l'emploi pour [Mistral Vibe](https://chat.mistral.ai/code/extensions) : un `AGENTS.md` (règles + style compressé), 11 skills DevOps / dev, et un system prompt custom qui force la lecture des skills, le git systématique et les réponses courtes. Installable en une commande.
